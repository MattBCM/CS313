...
public class myBST <T extends Comparable<T>>{
    ...
    private static <T extends Comparable<T>> BSTnode<T> insertRec(T object, BSTnode<T> t){
    ...
    private static <T extends Comparable<T>> T findMinRec(BSTnode<T> node){
    ...
    private static <T extends Comparable<T>> T findMaxRec(BSTnode<T> node){
    ...
    private static <T extends Comparable<T>> T searchRec(BSTnode<T> node, T data){
    ...
    private static <T extends Comparable<T>> BSTnode<T> deleteRec(BSTnode<T> node, T data){
        if(node.data.compareTo(data) == 0){ //data has been found
    ...
    private static <T extends Comparable<T>> int inOrderFill(BSTnode<T> node, Comparable<T>[] arr, int position){
